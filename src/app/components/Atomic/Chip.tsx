...
const CHIP_VARIANTS: Record<ChipVariant, Record<ChipColor, string>> = {
  ...
  outline: {
    ...
    secondary:
      "bg-transparent border-2 border-gray-500 text-gray-500 hover:bg-gray-50",
    success:
      "bg-transparent border-2 border-green-500 text-green-500 hover:bg-green-50",
    warning:
      "bg-transparent border-2 border-yellow-500 text-yellow-500 hover:bg-yellow-50",
    danger:
...
export const Chip: React.FC<ChipProps> = ({
  ...
  const isPredefinedColor =
    typeof color === "string" && color in CHIP_VARIANTS[variant];
