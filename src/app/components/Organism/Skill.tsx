...
import {
  TheorySkillProps,
  PracticalSkillProps,
} from "../../types/skill/skill.interface";
...
const generateSkillsWithIds = (
  skills: Omit<PracticalSkillProps, "id">[],
  startId: number = 1,
): PracticalSkillProps[] => {
...
const iconMap: Record<
  "Brain" | "Cpu" | "BookOpen" | "Layers" | "Math",
  React.ReactNode
> = {
...
const SkillCategory: React.FC<TheorySkillProps> = ({
  title,
  skills,
  icon,
  color,
  ...
  <div
    className={`relative p-6 rounded-2xl backdrop-blur-md border border-opacity-20 hover:border-opacity-40 transition-all duration-500 transform hover:scale-105 ${bgGradient} shadow-xl group`}
  >
...
const PracticalSkillsSection: React.FC<{
  title: string;
  skills: PracticalSkillProps[];
  subtitle: string;
...
const PracticalBlock = () => {
  const practicalSections = [
    ...
    {
      title: "MLOps & Workflow Tools",
      skills: generateSkillsWithIds(mlworkflowRaw, 30),
      subtitle: "Pipeline, Tracking & Deployment Management",
    },
  ];
...
export default function Skill() {
  ...
  return (
    <section className="min-h-screen relative overflow-hidden">
      ...
      <CloudLayer className="bottom-40" opacity={0.2} index={3} />
      <CloudLayer className="bottom-0" opacity={0.1} index={4} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-4">
            Journey through the stratosphere of knowledge, from theoretical
        ...
        <div>
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-emerald-300">
              Lower Atmosphere • Earth Surface • Implementation Layer
            </p>
