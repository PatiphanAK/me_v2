...
export const projectData: Project[] = [
  ...
  },
  {
    ...
    title: "Snap My Meal",
    description:
      "A RESTful API for food logging and analysis. Built with Rust's Axum framework and PostgreSQL for robust data management. The project includes a shell script for quick and easy setup of the development environment.",
    image: null,
